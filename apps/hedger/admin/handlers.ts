...
export default class AdminHandlers {
    ...
    public async list_resolver(): Promise<Response> {
        ...
        const markets = market_ids.length === 0
            ? []
    ...
    public async force_solana_resolve(market_id: string): Promise<Response> {
        ...
        await this.resolver_state.record_solana_resolved(market_id, result.signature, result.submittedAt);
    ...
    private parse_exposure_patch(
        ...
        | { ok: true; tracker_enabled?: boolean; paused?: boolean }
