                ...
                <div className="mt-6 space-y-3">
                    {market.candidates.map((candidate, i) => {
                        ...
                        return (
                            ...
                            >
                                <span className="font-mono text-[10px] text-white/70 w-28 truncate">
                                    {candidate.name}
                                </span>
                                ...
                                <span className="font-mono text-[11px] text-white/75 tabular-nums w-9 text-right">
                                    {candidate.probability}%
                                </span>
                                <span
                                    className={cn(
                                        'font-mono text-[9px] tabular-nums w-10 text-right',
