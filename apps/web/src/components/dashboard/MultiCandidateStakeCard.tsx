                ...
                <div className="mt-4 sm:mt-6 space-y-2.5 sm:space-y-3">
                    {market.candidates.map((candidate, i) => {
                        ...
                        return (
                            <div
                                key={candidate.name}
                                className="flex items-center gap-2 sm:gap-3 group/row cursor-pointer hover:bg-white/3 -mx-1 sm:-mx-2 px-1 sm:px-2 py-1.5 rounded-[4px] transition-colors"
                            >
                                <span className=" text-[12px] text-white/70 w-20 sm:w-32 truncate">
                                    {candidate.name}
                                </span>
                                ...
                                <span className=" text-[12px] sm:text-[13px] text-white/75 tabular-nums w-8 sm:w-10 text-right">
                                    {candidate.probability}%
                                </span>
                                <span
                                    className={cn(
                                        ' text-[11px] tabular-nums w-10 sm:w-12 text-right',
