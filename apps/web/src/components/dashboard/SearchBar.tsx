    ...
    return (
        <div className="relative w-full max-w-xl group">
            ...
            <input
                ...
                className="w-full h-10 bg-neutral-950 border border-white/10 rounded-none pl-10 pr-20 font-mono text-[11px] tracking-[0.15em] uppercase text-white/75 placeholder:text-white/35 outline-none focus:border-indigo-500/30 focus:ring-1 focus:ring-indigo-500/15 transition-colors"
            />
