    ...
    return (
        <div className="relative w-xl group ">
            ...
            <input
                ...
                className="w-full h-10 bg-[#101519] pl-10 pr-20 text-[13px] text-white/75 placeholder:text-white/35 transition-colors rounded-md outline-none focus:outline-none focus:ring-0"
            />
