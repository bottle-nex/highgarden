      ...
      <section className="max-w-7xl mx-auto w-full grid grid-cols-2">
        ...
        <div className="col-span-1">
          <p className="text-2xl">
            SolMarket fuses Polymarket-grade liquidity with sub-second Solana execution — so you can
            trade real-world outcomes without bridging, waiting, or paying Polygon gas.
          </p>
        </div>
      </section>
