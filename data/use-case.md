...
- Alice opens the page and sees: *"BTC > $150k by 2026 — YES 51¢ / NO 50¢"*. From her point of view, the book looks real and deep.
...
await clobClient.createAndPostOrder(
  { tokenID: YES_TOKEN, price: 0.50, side: Side.BUY, size: 100 },
...
- Frontend shows: *"Market temporarily unavailable. Please try again in a moment."*
